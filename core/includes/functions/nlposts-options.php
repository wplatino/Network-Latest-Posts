...
class NLPosts_Options {
     ...
     */
    public function nlposts_save_option( $option, $option_name ) {
        // Clean variables
     ...
     * 
     */
    private function nlposts_plugins_api($action, $args = null) {
    ...
    public function nlposts_repository_info() {
        $call_api = $this->nlposts_plugins_api( 'plugin_information', array( 'slug' => 'network-latest-posts' ) );
