...
$p_o = "<p>";
$p_c = "<p>";
$widget_form = "<form id='nlposts_shortcode' class='nlposts' name='nlposts_shortcode' method='POST' action=''>";

$widget_form.= "<h2>".__('Network Latest Posts Shortcode Settings','trans-nlp')."</h2>";
$widget_form.= "<hr />";

$widget_form.= "<div id='nlptabs'>";
    $widget_form.= '<ul>';
        $widget_form.= '<li><a href="#tab1" class="tab1">'.__('General Settings','trans-nlp').'</a></li>';
        $widget_form.= '<li><a href="#tab2" class="tab2">'.__('Posts','trans-nlp').'</a></li>';
        $widget_form.= '<li><a href="#tab3" class="tab3">'.__('Pagination & Sorting','trans-nlp').'</a></li>';
        $widget_form.= '<li><a href="#tab4" class="tab4">'.__('Thumbnails','trans-nlp').'</a></li>';
        $widget_form.= '<li><a href="#tab5" class="tab5">'.__('Style Settings','trans-nlp').'</a></li>';
    $widget_form.= '</ul>';
...
<script type="text/javascript" charset="utf-8">
    //<![CDATA[
    jQuery('#nlposts_shortcode').ready(function(){
        jQuery('#nlptabs').tabs();
    });
